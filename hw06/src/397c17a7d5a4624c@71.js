...
function _hw6_artist(__query,FileAttachment,invalidation){return(
__query(FileAttachment("hw6_artist.csv"),{from:{table:"hw6_artist"},sort:[],slice:{to:null,from:null},filter:[],select:{columns:null}},invalidation)
)}

function _hw6_public(__query,FileAttachment,invalidation){return(
__query(FileAttachment("hw6_public.csv"),{from:{table:"hw6_public"},sort:[],slice:{to:null,from:null},filter:[],select:{columns:null}},invalidation)
)}

function _artistver(hw6_artist){return(
hw6_artist
)}

function _artistpublic(hw6_public){return(
hw6_public
)}
...
Plot.plot({
  ...
  color: {
    ...
    range: ['#111111', '#999999'],  // 你可以根據需要更改顏色
    legend: true
  },
  marks: [
  ...
  series.forEach((serie) => {
      ...
      bars.enter().append("rect")
          ...
          .on("mouseover", function(d) {
              d3.select(this).attr("fill", "#EE1111");
...
export default function define(runtime, observer) {
  ...
  const fileAttachments = new Map([
    ["hw6_public.csv", {url: new URL("./files/41a9c6bfdf8907c7f19b5a52517012d51d11afcdf769218a6b5c1af5288c865ca2bf10f0fdac5144f8d3676054b833c736642053e880c85ec6123fb15744ae7f.csv", import.meta.url), mimeType: "text/csv", toString}],
    ["hw6_artist.csv", {url: new URL("./files/363ea43eed3c6a6a6fed83d3e26ac23641da56f4f0689da720760208af84f1c3caff531322fc2ceeaf3924e4ff2f0ca4314a49adfe0e45701c6687fc36ee24d3.csv", import.meta.url), mimeType: "text/csv", toString}]
  ]);
  main.builtin("FileAttachment", runtime.fileAttachments(name => fileAttachments.get(name)));
  main.variable(observer()).define(["md"], _1);
  main.variable(observer("hw6_artist")).define("hw6_artist", ["__query","FileAttachment","invalidation"], _hw6_artist);
  main.variable(observer("hw6_public")).define("hw6_public", ["__query","FileAttachment","invalidation"], _hw6_public);
  main.variable(observer("artistver")).define("artistver", ["hw6_artist"], _artistver);
  main.variable(observer("artistpublic")).define("artistpublic", ["hw6_public"], _artistpublic);
